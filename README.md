This solver is based on the same algorithms as https://github.com/Fossana/discounted-cfr-poker-solver but this implementation is 2-3x faster due to code optimizations and the use of C++.
